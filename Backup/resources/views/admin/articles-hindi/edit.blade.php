                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <form id="editform" method="post" class="form-horizontal" action="{{url('admin/articles/hindi/update')}}">
                                {{csrf_field()}}
                                {{ method_field('POST') }}
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <div style="margin-bottom: 10px" class="article-image {{empty($article->image_path) ?'dnone':''}}" id="image-preview">
                                                        ...
                                                        @else
                                                            <img class="preview" src="{{env('S3_BUCKET_URL','').Config('constants.ARTICLE_HINDI_UPLOAD_PATH').trim($article->image_path,'/')}}" />
                                                        @endif
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" name="eng_title" class="form-control" value="{{$article->eng_title}}"  placeholder="Title" >
                                                </div>
                                            </div>
...
@section('page-js-script')
    ...
    <script>
        $( document ).ready(function() {
            ...
            $('#authorId').select2({
                ...
                ajax: {
                    url: '{{url("admin/articles/hindi/get-authors")}}',
                    dataType: 'json',
                    delay: 250,
            ...
            $('#associatedTags').select2({
                ...
                ajax: {
                    url: '{{url("admin/articles/hindi/get-kickers")}}',
                    dataType: 'json',
                    delay: 250,
                    processResults: function (data) {
                        return {
            ...
            $('#audioId').select2({
                ...
                ajax: {
                    url: '{{url("admin/articles/hindi/get-audio-files")}}',
                    dataType: 'json',
                    delay: 250,
                    processResults: function (data) {
                        return {
    ...
    <script>
        ...
        $('body').on('click', '.article-delete', function(){
            ...
            if (imageId>0) {
                $.post("{{route('articleHindi.deleteArticleImage')}}",{imageId:imageId,_token:'{{ csrf_token() }}'});
            }
        });

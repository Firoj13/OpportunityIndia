            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-9">
                        <div class="row">
                            <div class="col-sm-3">
                                <a href="{{ route('article.create',['id' => 0]) }}" class="float-right btn btn-md btn-success">
                    ...
                    <table class="table table-striped projects">
                        ...
                        @foreach($articles as $article)
                            ...
                            <tr>
                                ...
                                <td><div class="round-button"><div class="round-button-circle"><a href="{{url('/article',str_slug($article->title).'-'.$article->id)}}" target="_blank" class="round-button">Go</a></div></div></td>
                                <td>
                                    @if($article->status==1)
                                ...
                                <td class="project-actions text-right">
                                    <a class="btn btn-info btn-sm" href="{{ route('article.edit',['id' => $article->id]) }}">
                                ...
                                <div class="modal-dialog modal-sm">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <form method="post" action="{{route('article.destroy',$article->id)}}" class="pull-right">
                                                {{csrf_field()}}
                                                {{method_field("DELETE")}}
    ...
    <script>
        $( document ).ready(function() {
            $(".btn-status").click(function(){
                ...
                $.post(baseUrl+"/admin/articles/english/status",{_token: "{{ csrf_token() }}",id:id,status:status},function(){

...
@section('content')
    ...
    <section class="content">
        <form id="editform" method="post" action="{{url('admin/authors/update')}}">
            {{csrf_field()}}
            {{ method_field('POST') }}
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="inputName" class="form-control" value="{{$author->name}}" minlength="2" required>
                            </div>
                            <div class="form-group">
                                <label for="inputCompany">Company</label>
                                <input type="text" name="company" id="inputCompany" class="form-control" value="{{$author->company}}" minlength="2">
                            </div>
                            <div class="form-group">
                                <label for="inputDesignation">Designation</label>
                                <input type="text" name="designation" id="inputDesignation" class="form-control" value="{{$author->designation}}" minlength="2">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div  class="author-image {{empty($author->image_path) ?'dnone':''}}" id="image-preview">
                                    @if(strstr($author->image_path,"/"))
                                        <img class="preview" src="{{ env('S3_BUCKET_URL','').trim($author->image_path,'/') }}" />
                                    @else
                                        <img class="preview" src="{{env('S3_BUCKET_URL','').'opp/authors/images/'.trim($author->image_path,'/')}}" />
                                    @endif
                                    <span class="image-delete icon-delete" data-id="{{$author->id}}"><i class="fas fa-trash"></i></span>
                                </div>
                    ...
                    <div class="card card-secondary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="email" name="email" id="inputEmail" class="form-control" value="{{$author->email}}">
                            </div>
                            <div class="form-group">
                                <label for="inputPhoneNumber">Phone Number</label>
                                <input type="number" name="phone_number" id="inputPhoneNumber" class="form-control" value="{{$author->phone_number}}">
                            </div>
                            <div class="form-group">
                                <label for="inputAddress">Address</label>
                                <input type="text" name="address" id="inputAddress" class="form-control" value="{{$author->address}}">
                            </div>
                            <div class="form-group">
                                <label for="inputLinkedinProfile">Linkedin Profile </label>
                                <input type="text" name="linkedin_profile" id="inputLinkedinProfile" class="form-control" value="{{$author->linkedin_profile}}">
                            </div>
                            <div class="form-group">
                                <label for="inputFacebookProfile">Facebook Profile</label>
                                <input type="text" name="facebook_profile" id="inputFacebookProfile" class="form-control" value="{{$author->fb_profile}}">
                            </div>
                            <div class="form-group">
                                <label for="inputTwitterProfile">Twitter Profile</label>
                                <input type="text" name="twitter_profile" id="inputTwitterProfile" class="form-control" value="{{$author->twitter_profile}}">
                            </div>
                            {{--              <div class="form-group">--}}
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <textarea  name="description" id="inputDescription" class="form-control" minlength="2">{{$author->intro_desc}}</textarea>
                            </div>
                        </div>
                        <!-- /.card-body -->
                    </div>
...
@section('page-js-script')
    ...
    <script>
        ...
        $('body').on('click', '.image-delete', function(){
            ...
            if (authorId>0) {
                $.post(baseUrl+"/admin/authors/delete/image",{authorId:authorId,_token:'{{ csrf_token() }}'});
            }
        });

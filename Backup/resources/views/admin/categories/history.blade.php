      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-4" style="margin:auto 0px">
            <h1 class="m-0">Industry / Sector history</h1>
          </div><!-- /.col -->
          <div class="col-sm-8">
            <div class="row">
              <div class="col-sm-12">
                ...
                <div class="card-body" style="display: block;">
                  <form action="{{url('admin/industry/history/')}}">
                    <div class="row">
                      <div class="col-md-5">
                        <div class="form-group">
                          <label>Industry / Sector ID</label>
                          <input class="form-control" type="text"  name="id" value="{{ app('request')->input('id') }}" placeholder="Industry / Sector ID">
                        </div>
                      </div>
                      <div class="col-md-5">
                        <div class="form-group">
                  ...
                  <tbody>
	         		...
	         		<tr>
		                ...
		                <td>
		                	...
		                	@else
		                		{{ $history->userResponsible()->name }} Changed {{ $history->fieldName()}} from <b>{{ \Illuminate\Support\Str::limit(str_replace([0,1],['inactive','active'],$history->oldValue()), 40, $end='...') }}</b> to <b>{{ \Illuminate\Support\Str::limit(str_replace([0,1],['inactive','active'],$history->newValue()), 40, $end='...') }}</b>
		                	@endif
		                </td>	                      
	                </tr>
	                @endforeach	

                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <form id="editform" method="post" class="form-horizontal" action="{{url('admin/news/english/update')}}">
                                {{csrf_field()}}
                                {{ method_field('POST') }}
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="card-body">
                                                ...
                                                <div class="col-sm-8">
                                                    <div style="margin-bottom: 10px" class="news-image {{empty($singleNews->image_path) ?'dnone':''}}" id="image-preview">
                                                        ...
                                                        @else
                                                            <img class="preview" src="{{env('S3_BUCKET_URL','').Config('constants.NEWS_UPLOAD_PATH').trim($singleNews->image_path,'/')}}" />
                                                        @endif

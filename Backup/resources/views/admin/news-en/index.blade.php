                        ...
                        @foreach($news as $singleNews)
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="round-button">
                                        <div class="round-button-circle">
                                            <a href="/news/{{str_slug($singleNews->title).'.'.$singleNews->id}}"
                                ...
                                <td class="project-actions text-center">
                                    <a class="btn btn-info btn-sm" href="{{ route('news.edit',['id' => $singleNews->id]) }}">
    ...
    <script>
        $(document).ready(function () {
            $(".btn-status").click(function () {
                ...
                $.post(baseUrl + "/admin/news/english/status", {
                    _token: "{{ csrf_token() }}",
                    id: id,
                    status: status
                }, function () {

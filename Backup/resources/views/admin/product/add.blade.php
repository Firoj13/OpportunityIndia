...
<div class="content-header">
   <div class="container-fluid">
      <div class="row mb-2">
         <div class="col-sm-3"><h3>Add Product</h3></div>
         <!-- /.col -->
         <div class="col-sm-9" >
                                            ...
                                            <div class="card-body">
                                              <div class="tab-content" id="custom-tabs-four-tabContent">
                                                ...
                                                <div class="tab-pane fade {{$key=='en'?'show active':''}}" id="custom-tabs-four-{{$key}}" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
                                                  <div class="form-group row">
                                                      <div class="col-sm-12">
                                                         <input type="text" name="productName[{{$key}}]" class="form-control"  placeholder="Product Name (in {{$lang}})"  required maxlength="255">
                                                      </div>
                                                   </div>
                                ...
                                <div class="form-group row">
                                   ...
                                   <div class="col-sm-9">
                                      <div class="form-group">
                                        <!-- <label for="customFile">Custom File</label> -->
                                  		<div style="margin-bottom: 10px" class="dnone" id="banner-preview"></div>
                        ...
                        <div class="col-sm-3">
                           <div class="back">
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-6">
                                    <a href="{{url('/admin/products/'.$brand->brand_id)}}"><button type="button" class="btn btn-block btn-secondary btn-flat">Cancel</button></a>
                                 </div>
                              </div>
                              <div class="form-group row">
...
@section('page-js-script')
	...
	$( document ).ready(function() { 
        ...
        let len=$('#attribute-table tr').length;
				let input1=$('<input class="form-control" type="text" name="attribute['+len+'][key]" value="" placeholder="Specification Title">');
				let input2=$('<input class="form-control" type="text" name="attribute['+len+'][value]" value="" placeholder="Specification Value">');

				let cnt=$('#attribute-table tr').length;
				let tr=$('<tr/>');
				let td=$('<td/>');

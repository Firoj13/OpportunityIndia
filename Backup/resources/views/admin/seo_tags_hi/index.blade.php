        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-9">
                    <div class="row">
                        <div class="col-sm-3">
                            <a href="{{url('admin/seo-tags-hi/create')}}"  class="btn btn-block btn-primary btn-flat">Add New Tag</a>
                        </div>
                        <div class="col-sm-9">
                            <form action="{{url('admin/seo-tags-hi')}}">
                                        ...
                                        <table id="example2" class="table table-bordered table-hover">
                                            ...
                                            @foreach($items as $index=>$item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{url('admin/seo-tags-hi/edit/'.$item->id)}}" style="color: #000">

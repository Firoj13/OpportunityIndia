    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-4" style="margin:auto 0px">
          <h1 class="m-0">Manufacturer History</h1>
        </div><!-- /.col -->
          <div class="col-sm-8">
            <div class="row">
              <div class="col-sm-12">
                ...
                <div class="card-body" style="display: block;">
                  <form action="{{url('admin/manufacturers/history')}}">
                    <div class="row">
                      <div class="col-md-5">
                        <div class="form-group">
                          <label>Manufacturer ID</label>
                          <input class="form-control" type="text"  name="id" value="{{ app('request')->input('id') }}" placeholder="Manufacturer ID">
                        </div>
                      </div>
                      <div class="col-md-5">
                        <div class="form-group">

 ...
 <!-- Content Header (Page header) -->
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-3">
          <h1 class="m-0">Add New Sector</h1>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
  </div>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
            ...
            <div class="card-header">
              ...
              <div class="row">
                ...
                <div class="card-body">
                  ...
                  <div class="col-sm-9">
                    <div style="margin-bottom: 10px" class="dnone" id="preview-container">
         ...
         <div class="form-group row">
          <div class="col-sm-6">
        <button type="submit" class="btn btn-sm btn-success btn-lg">Add Sector</button>
          </div>
          <div class="col-sm-6">

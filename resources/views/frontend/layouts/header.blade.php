...
<!--               <li class="active"><a href="#">Home</a></li> -->
                ...
                @if(App::getLocale() == 'en')  <li><a href="{{\App\Http\Controllers\Frontend\IndexController::createTagSlugUrl(preg_replace("/[\s]/", '-',strtolower(Lang::get('messages.StartupURL'))))}}">{{ Lang::get('messages.Startup') }}</a></li> @else <li><a href="{{\App\Http\Controllers\Frontend\IndexController::createTagSlugUrl(preg_replace("/[\s]/", '-',strtolower(Lang::get('messages.StartupURL'))))}}">{{ Lang::get('messages.Startup') }}</a></li> @endif
           ...
           <div class="search-main mx-auto">
                    ...
                    <span id="tog1">
   <img src="{{asset('images/search.svg')}}" alt="Search" style="">
   <img src="{{asset('images/cross.png')}}" alt="Close" style="display: none;">
</span>
                </div>

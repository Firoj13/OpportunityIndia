...
@section('seoTitle', $catexist->name.Lang::get('messages.TagTitle'))
@section('seoKeywords', $catexist->name.Lang::get('messages.TagTitle'))
@section('seoDesc', $catexist->name.Lang::get('messages.TagTitle'))
@section('shortDesc', $catexist->name.Lang::get('messages.TagTitle'))
...
@section('alturls')
@if(App::getLocale() == 'en')
<link rel="alternate" href="{{url(\App\Http\Controllers\Frontend\IndexController::createTagSlugUrl($catexist->slug))}}" hreflang="en-IN" />
@else
<link rel="alternate" href="{{url(\App\Http\Controllers\Frontend\IndexController::createTagSlugUrl($catexist->slug))}}" hreflang="hi-IN" />
@endif
@stop
@section('content')

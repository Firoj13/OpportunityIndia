...
<div class="listblk">
  <div class="container">
  	...
  	<ul class="artilsit">
        <?php $__currentLoopData = $listVideo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if($loop->index < 5): ?>
           <li>
                        ...
                        <div class="col-lg-5 col-md-5">
                            <a class="popup-youtube" href="https://www.youtube.com/watch?v=-vvLupirg8U">
                                <div class="artimgblk">
                                    ...
                                    <span class="artimgblk-yt"><img src="<?php echo e(url('images/play-button.svg')); ?>"></span>
                            ...
                            <div class="artcontent myartlist">
                                ...
                                <div class="myblk">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 myblk-rt col-sm-6 col-xs-6"><img src="<?php echo e(asset('images/viewnew.png')); ?>"> <span>12</span></div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-5">
                            <a class="popup-youtube" href="<?php echo e($lv['url']); ?>">
                                <div class="artimgblk">
                                    <span class="overnew"></span>
                                    <span class="artimgblk-yt"><img src="<?php echo e(url('images/play-button.svg')); ?>"></span>
                                    <img src="<?php echo e($lv['image']); ?>" alt="<?php echo e($lv['title']); ?>">
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-lg-7 col-md-7">
                            <div class="artcontent myartlist">
                                <div class="haedname"><a href="<?php echo e($lv['url']); ?>"><?php echo e($lv['title']); ?></a></div>

                                <div class="myblk">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 myblk-lt col-sm-6 col-xs-6"><?php echo e($lv['createDate']); ?></div>
                                        <div class="col-lg-6 col-md-6 myblk-rt col-sm-6 col-xs-6"><img src="<?php echo e(asset('images/viewnew.png')); ?>"> <span><?php echo e($lv['views']); ?></span></div>

                                    </div>
                                </div>
                                <div class="stext"><?php echo e($lv['title']); ?></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="artcontent myartlist">
                                ...
                                <div class="myblk">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 myblk-rt col-sm-6 col-xs-6"><img src="<?php echo e(asset('images/viewnew.png')); ?>"> <span>46</span></div>
                                    </div>
                                </div>
                            ...
                            <div class="artcontent myartlist">
                                ...
                                <div class="myblk">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 myblk-rt col-sm-6 col-xs-6"><img src="<?php echo e(asset('images/viewnew.png')); ?>"> <span>87</span></div>
                                    </div>
                                </div>
                            ...
                            <div class="artcontent myartlist">
                                ...
                                <div class="myblk">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 myblk-rt col-sm-6 col-xs-6"><img src="<?php echo e(asset('images/viewnew.png')); ?>"> <span>86</span></div>
                                    </div>
                                </div>
...
<li>
<div class="imgbl">
<div class="playbtn"><img src="<?php echo e(url('images/play-buttongrey.svg')); ?>"></div>
    <a href="https://www.gauravmarya.com/podcast/" target="_blank">
        <img src="<?php echo e(url('images/gwg/gwg12.jpg')); ?>" class="pdimg"></a></div>
<div class="conblk">
...
<li>
<div class="imgbl"><div class="playbtn"><img src="<?php echo e(url('images/play-buttongrey.svg')); ?>">
    </div><a href="https://www.gauravmarya.com/podcast/" target="_blank">
        <img src="<?php echo e(url('images/gwg/gwg11.jpg')); ?>" class="pdimg"></a>
    </div>
<div class="conblk">
...
<div class="imgbl"><div class="playbtn"><img src="<?php echo e(url('images/play-buttongrey.svg')); ?>">
        ...
        <a href="https://www.gauravmarya.com/podcast/" target="_blank"><img src="<?php echo e(url('images/gwg/gwg10.jpg')); ?>" class="pdimg"></a>
    </div>
<div class="conblk">
...
<li>
<div class="imgbl"><div class="playbtn"><img src="<?php echo e(url('images/play-buttongrey.svg')); ?>"></div>
    <a href="https://www.gauravmarya.com/podcast/" target="_blank"><img src="<?php echo e(url('images/gwg/gwg9.jpg')); ?>" class="pdimg"></a></div>
<div class="conblk">
...
<div class="imgbl"><div class="playbtn"><img src="<?php echo e(url('images/play-buttongrey.svg')); ?>">
        ...
        <img src="<?php echo e(url('images/gwg/gwg8.jpg')); ?>" class="pdimg"></a></div>
<div class="conblk">
...
<li>
<div class="imgbl"><div class="playbtn"><img src="<?php echo e(url('images/play-buttongrey.svg')); ?>"></div>
    <a href="https://www.gauravmarya.com/podcast/" target="_blank"><img src="<?php echo e(url('images/gwg/gwg7.jpg')); ?>" class="pdimg"></a></div>
<div class="conblk">
...
<div class="listblk">
  <div class="container">
    ...
    <ul class="artilsit">
        <?php $__currentLoopData = $listVideo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if($loop->index >4 && $loop->index <10 ): ?>
                     <li>
...
<div class="playbtn"><img src="<?php echo e(url('images/play-buttongrey.svg')); ?>"></div>
    <a href="https://www.thefranchisingworld.com/" target="_blank">
        <img src="<?php echo e(url('images/tfw/tfw12.jpg')); ?>" class="pdimg"></a></div>
<div class="conblk">
...
<div class="imgbl"><div class="playbtn"><img src="<?php echo e(url('images/play-buttongrey.svg')); ?>">
        ...
        <img src="<?php echo e(url('images/tfw/tfw11.jpg')); ?>" class="pdimg"></a>
    </div>
<div class="conblk">
...
<div class="imgbl"><div class="playbtn"><img src="<?php echo e(url('images/play-buttongrey.svg')); ?>">
        ...
        <a href="https://www.thefranchisingworld.com/" target="_blank"><img src="<?php echo e(url('images/tfw/tfw10.jpg')); ?>" class="pdimg"></a>
    </div>
<div class="conblk">
...
<li>
<div class="imgbl"><div class="playbtn"><img src="<?php echo e(url('images/play-buttongrey.svg')); ?>"></div>
    <a href="https://www.thefranchisingworld.com/" target="_blank"><img src="<?php echo e(url('images/tfw/tfw9.jpg')); ?>" class="pdimg"></a></div>
<div class="conblk">
...
<div class="imgbl"><div class="playbtn"><img src="<?php echo e(url('images/play-buttongrey.svg')); ?>">
        ...
        <img src="<?php echo e(url('images/tfw/tfw8.jpg')); ?>" class="pdimg"></a></div>
<div class="conblk">
...
<li>
<div class="imgbl"><div class="playbtn"><img src="<?php echo e(url('images/play-buttongrey.svg')); ?>"></div>
    <a href="https://www.thefranchisingworld.com/" target="_blank"><img src="<?php echo e(url('images/tfw/tfw7.jpg')); ?>" class="pdimg"></a></div>
<div class="conblk">
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/franchis/public_html/subdomains/opportunityindia/resources/views/frontend/podcast.blade.php ENDPATH**/ ?>
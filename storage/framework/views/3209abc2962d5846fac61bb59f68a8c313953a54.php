                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <form id="editform" method="post" class="form-horizontal" action="<?php echo e(url('admin/articles/english/update')); ?>">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <div style="margin-bottom: 10px" class="article-image <?php echo e(empty($article->image_path) ?'dnone':''); ?>" id="image-preview">
                                                        ...
                                                        <?php else: ?>
                                                            <img class="preview" src="<?php echo e(env('S3_BUCKET_URL','').Config('constants.ARTICLE_UPLOAD_PATH').trim($article->image_path,'/')); ?>" />
                                                        <?php endif; ?>
...
<?php $__env->startSection('page-js-script'); ?>
    ...
    <script>
        ...
        $( document ).ready(function() {
            ...
            $('#authorId').select2({
                ...
                ajax: {
                    url: '<?php echo e(url("admin/articles/english/get-authors")); ?>',
                    dataType: 'json',
                    delay: 250,
            ...
            $('#associatedTags').select2({
                ...
                ajax: {
                    url: '<?php echo e(url("admin/articles/english/get-kickers")); ?>',
                    dataType: 'json',
                    delay: 250,
                    processResults: function (data) {
                        return {
            ...
            $('#audioId').select2({
                ...
                ajax: {
                    url: '<?php echo e(url("admin/articles/english/get-audio-files")); ?>',
                    dataType: 'json',
                    delay: 250,
                    processResults: function (data) {
                        return {
    ...
    <script>
        ...
        $('body').on('click', '.article-delete', function(){
            ...
            if (imageId>0) {
                $.post("<?php echo e(route('article.deleteArticleImage')); ?>",{imageId:imageId,_token:'<?php echo e(csrf_token()); ?>'});
            }
        });
...
<?php echo $__env->make("admin/layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/franchis/public_html/subdomains/opportunityindia/resources/views/admin/articles/edit.blade.php ENDPATH**/ ?>
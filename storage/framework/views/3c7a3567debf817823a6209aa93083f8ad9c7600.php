<?php $__env->startSection('content'); ?>
    <div class="maininnver homeh">
        <div class="container">
            ...
            <form class="form-horizontal mt-5" id="contactForm" action="<?php echo e(url('contactsubmit')); ?>" method="post">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/franchis/public_html/subdomains/opportunityindia/resources/views/frontend/contact.blade.php ENDPATH**/ ?>
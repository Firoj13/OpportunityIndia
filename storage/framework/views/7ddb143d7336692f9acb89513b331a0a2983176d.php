...
<?php $__env->startSection('content'); ?>
    <div class="maininnver homeh">
        <div class="container">
            <h1 class="cathead">Search for <?php echo e(Illuminate\Support\Str::limit($search, 10,'...')); ?></h1>
        </div>
    ...
    <script>
        ...
        $(function(){
             ...
             $('.readmore').click(function(){
                 $.ajax({
                     url: "/seach-article/<?php echo e($search); ?>/"+page,
                     method: "GET",
                 }).done(function( data ) {
                     if(data){
                         page++;
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/franchis/public_html/subdomains/opportunityindia/resources/views/frontend/search.blade.php ENDPATH**/ ?>
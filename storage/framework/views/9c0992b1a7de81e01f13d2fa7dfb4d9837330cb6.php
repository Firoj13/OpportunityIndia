                ...
                <tbody><tr>
                    <td valign="top" class="mt-tbl"><table width="100%" class="tbl-mo" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td width="70%" valign="top" class="td-value" style="background:#f9f9f9; color:#333333;line-height:21px;padding:10px 0;"><?php echo e($feedbackTopic); ?></td>
                            </tr>
                            <tr>
                                <td colspan="3" valign="top" height="1" bgcolor="#eaeaea"></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td height="70%" valign="top" class="td-value" style="background:#f4f4f4; color:#333333;line-height:21px;padding:10px 0;"><?php echo e($feedback); ?></td>
                            </tr>
                            <tr>
                                <td colspan="3" valign="top" height="1" bgcolor="#eaeaea"></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td width="5%" valign="top" class="td-dot" style="background:#f4f4f4;padding:10px 20px 10px 0;">:</td>
                                <td height="70%" valign="top" class="td-value" style="background:#f4f4f4; color:#333333;line-height:21px;padding:10px 0;"><?php echo e($site); ?></td>
                            </tr>
                            <tr>
                                <td colspan="3" valign="top" height="1" bgcolor="#eaeaea"></td>
                            </tr>
...
<?php /**PATH /home/franchis/public_html/subdomains/opportunityindia/resources/views/frontend/mail/sitefeedback.blade.php ENDPATH**/ ?>
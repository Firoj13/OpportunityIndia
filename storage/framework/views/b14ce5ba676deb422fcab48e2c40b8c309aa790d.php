        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-9">
                    <div class="row">
                        <div class="col-sm-3">
                            <a href="<?php echo e(url('admin/seo-tags/create')); ?>"  class="btn btn-block btn-primary btn-flat">Add New Tag</a>
                        </div>
                        <div class="col-sm-9">
                            <form action="<?php echo e(url('admin/seo-tags')); ?>">
                                        ...
                                        <table id="example2" class="table table-bordered table-hover">
                                            ...
                                            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo e(url('admin/seo-tags/edit/'.$item->id)); ?>" style="color: #000">
...
<?php echo $__env->make("admin/layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/franchis/public_html/subdomains/opportunityindia/resources/views/admin/seo_tags_eng/index.blade.php ENDPATH**/ ?>
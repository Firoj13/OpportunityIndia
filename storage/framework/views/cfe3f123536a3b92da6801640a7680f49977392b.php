...
<!--               <li class="active"><a href="#">Home</a></li> -->
                ...
                <?php if(App::getLocale() == 'en'): ?>   <li><a href="<?php echo e(\App\Http\Controllers\Frontend\IndexController::createTagSlugUrl(preg_replace("/[\s]/", '-',strtolower(Lang::get('messages.StartupURL'))))); ?>" target="_blank"><?php echo e(Lang::get('messages.Startup')); ?></a></li> <?php else: ?> <li><a href="<?php echo e(\App\Http\Controllers\Frontend\IndexController::createTagSlugUrl(preg_replace("/[\s]/", '-',strtolower(Lang::get('messages.StartupURL'))))); ?>" target="_blank"><?php echo e(Lang::get('messages.Startup')); ?></a></li> <?php endif; ?>
...
<?php /**PATH /home/franchis/public_html/subdomains/opportunityindia/resources/views/frontend/layouts/header.blade.php ENDPATH**/ ?>
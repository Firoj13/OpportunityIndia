    ...
    <section class="content-header">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-3">
                        <h1 class="m-0">English Articles List</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-9">
                        <div class="row">
                            <div class="col-sm-3">
                                <a href="<?php echo e(route('article.create',['id' => 0])); ?>" class="float-right btn btn-md btn-success">
                                    <i class="fa fa-plus-circle"></i> Add New Article
                                </a>
                            </div>
                            <div class="col-sm-9">
                                <form action="<?php echo e(route('article.index')); ?>">
                    ...
                    <table class="table table-striped projects">
                        ...
                        <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td><div class="round-button"><div class="round-button-circle"><a href="<?php echo e(url('/article',str_slug($article->title).'-'.$article->id)); ?>" target="_blank" class="round-button">Go</a></div></div></td>
                                <td>
                                ...
                                <td class="project-actions text-right">
                                    <a class="btn btn-info btn-sm" href="<?php echo e(route('article.edit',['id' => $article->id])); ?>">
                                ...
                                <div class="modal-dialog modal-sm">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <form method="post" action="<?php echo e(route('article.destroy',$article->id)); ?>" class="pull-right">
    ...
    <script>
        $( document ).ready(function() {
            $(".btn-status").click(function(){
                ...
                $.post(baseUrl+"/admin/articles/english/status",{_token: "<?php echo e(csrf_token()); ?>",id:id,status:status},function(){
...
<?php echo $__env->make("admin/layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/franchis/public_html/subdomains/opportunityindia/resources/views/admin/articles/index.blade.php ENDPATH**/ ?>